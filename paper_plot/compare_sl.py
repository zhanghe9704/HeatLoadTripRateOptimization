...
path = 'Plot/SL/2017_01_28__00_41_37__compare'
...
ax1.set_xlim(xmin=2600, xmax=3000)
ax1.set_xticks(np.arange(2600, 3000+1, 100))
...
plt.tight_layout()
plt.savefig(path+'/compare_sl.eps', format="eps")
plt.savefig(path+'/compare_sl.pdf', format="pdf")
plt.savefig(path+'/compare_sl.png', format="png")
plt.show()